...
const en: Dictionary = {
  ...
  coverage: {
    ...
    awaitingCourier: 'Order confirmed — tracking starts when the courier sets off',
    noActiveOrder: 'You have no active order',
...
const ru: Dictionary = {
  ...
  hero: {
    ...
    subtitle: '19-литровые бутылки натуральной родниковой воды из долины Варзоб — профессионально очищенной и доставляемой на дом и в офис.',
  ...
  coverage: {
    ...
    awaitingCourier: 'Заказ подтверждён — отслеживание начнётся, когда курьер выедет',
    noActiveOrder: 'У вас нет активного заказа',
...
const tg: Dictionary = {
  ...
  hero: {
    ...
    orderVia: 'Фармоиш тавассути',
    callToOrder: 'Занг занед',
    whatsapp: 'WhatsApp',
  ...
  coverage: {
    ...
    awaitingCourier: 'Фармоиш тасдиқ шуд — пайгирӣ ҳангоми ба роҳ баромадани қурйер оғоз мешавад',
    noActiveOrder: 'Шумо фармоиши фаъол надоред',
