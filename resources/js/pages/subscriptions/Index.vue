    ...
    <div class="space-y-4 md:space-y-6 container mx-auto px-4 md:px-0">
      ...
      <Card class="shadow-sm">
        <CardContent class="p-0">
          ...
          <!-- Pagination -->
          <div v-if="subscriptions.meta?.last_page > 1" class="px-6 py-4 border-t flex flex-wrap gap-1 bg-gray-50/50 dark:bg-gray-800/30">
            <template v-for="(link, key) in subscriptions.meta.links" :key="key">
