  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="relative overflow-x-auto sm:rounded-lg">
      ...
      <div class="p-4 flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-6 bg-white dark:bg-gray-900">
        <div>
          <h1 class="text-xl font-semibold text-gray-900 dark:text-white">{{ t('Create New User') }}</h1>
          <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">{{ t('Add a new user to organization') }}</p>
        </div>
      </div>
          ...
          <div class="px-4 py-5 sm:p-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 mt-5">
              ...
              <div class="grid gap-2">
                ...
                <Input id="password" class="mt-1 block w-full" name="password" v-model="form.password" required autocomplete="new-password" :placeholder="t('Enter password (min. 8 characters)')" />
