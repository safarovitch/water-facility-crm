...
const form = useForm({
  ...
  raw_materials: [] as { id: number; quantity: number }[],
});
        ...
        <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg px-4 py-5 sm:p-6">
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
            <div class="grid gap-2">
              ...
              <NumberField id="price" :step="0.01" :min="0" :controls="false" v-model="form.price" required placeholder="0.00" />
              <InputError :message="form.errors.price" />
            </div>
            <div class="grid gap-2">
              <Label for="sale_price">{{ t('Sale Price') }}</Label>
              <NumberField id="sale_price" :step="0.01" :min="0" :controls="false" v-model="form.sale_price" placeholder="0.00" />
              <InputError :message="form.errors.sale_price" />
            </div>
            <div class="grid gap-2">
              <Label for="cost">{{ t('Cost') }}</Label>
              <NumberField id="cost" :step="0.01" :min="0" :controls="false" v-model="form.cost" placeholder="0.00" />
        ...
        <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg px-4 py-5 sm:p-6">
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div class="grid gap-2">
              ...
              <NumberField id="weight" :step="0.01" :min="0" :controls="false" v-model="form.weight" placeholder="0.00" />
            </div>
