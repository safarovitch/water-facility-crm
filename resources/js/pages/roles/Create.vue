    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="relative overflow-x-auto sm:rounded-lg">
            ...
            <div class="p-4 flex items-center justify-between flex-column flex-wrap md:flex-row space-y-4 md:space-y-0 pb-6 bg-white dark:bg-gray-900">
                <div>
                    <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Create new role</h1>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new role to organization</p>
                </div>
            </div>
